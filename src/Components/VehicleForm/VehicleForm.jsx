...
const VehicleForm = (props) => {
    ...
    return (
        <form onSubmit={handleSubmit} className="vehicle-form">
            ...
            <select id="dropdown" type="text" onChange={(el) => setEngineSize(el.target.value)} value={engineSize}>
            ...
            <select id="dropdown" type="text" onChange={(el) => setTransmissionType(el.target.value)} value={transmissionType}>
                <option placeholder="transmission_type">Transmission</option>
                <option value="Automatic">Automatic</option>
                <option value="Manual">Manual</option>
                <option value="CVT">CVT</option>
            </select>
            <select id="dropdown" type="text" onChange={(el) => setDriveType(el.target.value)} value={driveType}>
            ...
            <select id="dropdown" type="text" onChange={(el) => setFuelType(el.target.value)} value={fuelType}>
