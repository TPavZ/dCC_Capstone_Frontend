    ...
    return (
        <div className="service-form">
            <form id="service-form2">
                ...
                <div><input name="major_repairs" type="text" value={majorRepairs} placeholder="Major Repairs?" onChange={(e) => setMajorRepairs(e.target.value)}></input> </div>
                <div><input name="other_services" type="text" value={otherServices} placeholder="Other Services?" onChange={(e) => setOtherServices(e.target.value)}></input> </div>
                <div><input name="service_details" type="text" value={serviceDetails} placeholder="Service Details..." onChange={(e) => setServiceDetails(e.target.value)}></input> </div>
