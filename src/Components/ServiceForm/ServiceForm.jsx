...
const ServiceForm = (props) => {
    ...
    function handleSubmit(el) {
        ...
        let vehicleInfo = {
            ...
            "differential_ervice": differentialService,
            ...
            "mechanical_rnvestigation": mechanicalInvestigation,
    ...
    return (
        <div className="service-form">
            <form>
                ...
                <div><input type="checkbox" name="battery_service" id="true" value={batteryService} onChange={(el) => setBatteryService(el.target.value)}></input> Something</div>
                <div><input type="checkbox" name="brakefluid_service" id="true" value={brakefluidService} onChange={(el) => setBrakefluidService(el.target.value)}></input> Something</div>
                <div><input type="checkbox" name="brakefront_service" id="true" value={brakefrontService} onChange={(el) => setBrakefrontService(el.target.value)}></input> Something</div>
                <div><input type="checkbox" name="brakerear_service" id="true" value={brakerearService} onChange={(el) => setBrakerearService(el.target.value)}></input> Something</div>
                <div><input type="checkbox" name="bulb_replacement" id="true" value={bulbReplacement} onChange={(el) => setBulbReplacement(el.target.value)}></input> Something</div>
                <div><input type="checkbox" name="cabinfilter_replacement" id="true" value={cabinfilterReplacement} onChange={(el) => setCabinfilterReplacement(el.target.value)}></input> Something</div>
                <div><input type="checkbox" name="coolant_service" id="true" value={coolantService} onChange={(el) => setCoolantService(el.target.value)}></input> Something</div>
                <div><input type="checkbox" name="differential_ervice" id="true" value={differentialService} onChange={(el) => setDifferentialService(el.target.value)}></input> Something</div>
                <div><input type="checkbox" name="drivebelt_replacement" id="true" value={drivebeltReplacement} onChange={(el) => setDrivebeltReplacement(el.target.value)}></input> Something</div>
                <div><input type="checkbox" name="electrical_investigation" id="true" value={electricalInvestigation} onChange={(el) => setElectricalInvestigation(el.target.value)}></input> Something</div>
                <div><input type="checkbox" name="enginefilter_replacement" id="true" value={enginefilterReplacement} onChange={(el) => setEnginefilterReplacement(el.target.value)}></input> Something</div>
                <div><input type="checkbox" name="exahust_service" id="true" value={exahustService} onChange={(el) => setExahustService(el.target.value)}></input> Something</div>
                <div><input type="checkbox" name="fuelfilter_replacement" id="true" value={fuelfilterReplacement} onChange={(el) => setFuelfilterReplacement(el.target.value)}></input> Something</div>
                <div><input type="checkbox" name="mechanical_rnvestigation" id="true" value={mechanicalInvestigation} onChange={(el) => setMechanicalInvestigation(el.target.value)}></input> Something</div>
                <div><input type="checkbox" name="oil_change" id="true" value={oilChange} onChange={(el) => setOilChange(el.target.value)}></input> Something</div>
                <div><input type="checkbox" name="powersteering_service" id="true" value={powersteeringService} onChange={(el) => setPowersteeringService(el.target.value)}></input> Something</div>
                <div><input type="checkbox" name="sparkplug_service" id="true" value={sparkplugService} onChange={(el) => setSparkplugService(el.target.value)}></input> Something</div>
                <div><input type="checkbox" name="steering_repair" id="true" value={steeringRepair} onChange={(el) => setSteeringRepair(el.target.value)}></input> Something</div>
                <div><input type="checkbox" name="suspension_repair" id="true" value={suspensionRepair} onChange={(el) => setSuspensionRepair(el.target.value)}></input> Something</div>
                <div><input type="checkbox" name="tire_repair" id="true" value={tireRepair} onChange={(el) => setTireRepair(el.target.value)}></input> Something</div>
                <div><input type="checkbox" name="tire_replacement" id="true" value={tireReplacement} onChange={(el) => setTireReplacement(el.target.value)}></input> Something</div>
                <div><input type="checkbox" name="tire_rotation" id="true" value={tireRotation} onChange={(el) => setTireRotation(el.target.value)}></input> Something</div>
                <div><input type="checkbox" name="transfercase_service" id="true" value={transfercaseService} onChange={(el) => setTransfercaseService(el.target.value)}></input> Something</div>
                <div><input type="checkbox" name="transmission_service" id="true" value={transmissionService} onChange={(el) => setTransmissionService(el.target.value)}></input> Something</div>
                <div><input type="checkbox" name="wiperblade_replacement" id="true" value={wiperbladeReplacement} onChange={(el) => setWiperbladeReplacement(el.target.value)}></input> Something</div>
